  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Indian Journals for Central Library</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Indian Journals</h5>
              </div>
              <div class="card-body">
				<?php 
					if(isset($_POST['add']))
					{
						...
						$sql= "INSERT INTO `library_indjrnl`(`branches`,`periodicalname`) VALUES ('$branches','$periodicalname')";
                ...
                <table class="table table-bordered">
					...
					<tbody>
						...
						<?php 
							$sql="SELECT * FROM `library_indjrnl`";
							$query=mysqli_query($conn, $sql);
